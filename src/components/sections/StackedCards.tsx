      ...
      >
        ...
        <div className="relative grid md:grid-cols-12 gap-10 items-center">
          <div className="md:col-span-3">
            <div className="font-display text-7xl md:text-9xl text-[var(--ink)] leading-none font-light ">
              {item.n}
            </div>
          </div>
          <div className="md:col-span-9">
            <h3 className="font-display text-4xl md:text-7xl text-[var(--ink)] leading-[1.0] font-light">
              {item.title}
            </h3>
            <p className="mt-6 text-[var(--ink-soft)] text-lg max-w-2xl leading-relaxed">
              {item.text}
            </p>
          </div>
        </div>
